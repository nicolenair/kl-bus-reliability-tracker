...
select planned_departure_time, planned_arrival_time, DATE(position_timestamp) as d, route_id, trip_id, stop_id, stop_sequence, min(ST_DISTANCE(ST_GEOGPOINT(expanded_veh_positions.longitude, expanded_veh_positions.latitude), ST_GEOGPOINT(stop_lon, stop_lat))) from expanded_veh_positions where route_id="T805" and trip_id="260313020039S10" and DATE(position_timestamp)=DATE("2026-03-23") group by expanded_veh_positions.route_id, expanded_veh_positions.trip_id, expanded_veh_positions.stop_id, stop_sequence, DATE(position_timestamp), planned_departure_time, planned_arrival_time;
